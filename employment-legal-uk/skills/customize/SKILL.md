...
The user typed `/employment-legal-uk:customize`. They want to change something
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `/employment-legal-uk:cold-start-interview`
...
6. **Close.**
   ...
   > run `/employment-legal-uk:customize` anytime.
