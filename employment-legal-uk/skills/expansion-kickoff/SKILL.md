...
3. If a tracker file already exists for this country (`~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/expansion-[slug].yaml`),
...
4. Create `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/expansion-[slug].yaml` on completion.

## Examples

```
/employment-legal-uk:expansion-kickoff Germany
```
