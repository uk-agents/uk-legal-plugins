...
Read `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/expansion-[slug].yaml
...
Run `/employment-legal-uk:expansion-update [country]` to update status
as items close.
```
