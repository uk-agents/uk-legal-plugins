...
Prepend the work-product header from `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/CLAUDE.md` → escalation table, any investigation protocols noted.

---

## Mode 1: Open a new matter

Triggered by `/employment-legal-uk:investigation-open` or "open an investigation"
...
`~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/investigation-[matter-slug]/log.yaml`:
...
`~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/investigation-[slug]/sources-checklist.yaml`.

---

## Mode 2: Add data

Triggered by `/employment-legal-uk:investigation-add` or "add to the [matter]
investigation" or when the attorney pastes documents or interview notes.

### Step 1 — Identify the matter

If multiple investigation folders exist in `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/`, ask which matter this
...
Triggered by `/employment-legal-uk:investigation-query` or any question
...
Triggered by `/employment-legal-uk:investigation-memo` or "draft the memo"
or "update the memo".
...
Write the draft to `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/investigation-[slug]/memo.md`.
...
Triggered by `/employment-legal-uk:investigation-summary` or "draft a
...
**Before producing a summary, memo, or content intended for an external response (ET claim response, EHRC investigation response, ICO inquiry response, claimant's-solicitor letter response, regulator response, or any formal complaint reply):** Read `## Who's using this` in `~/.claude/plugins/config/uk-legal-plugins/employment-legal-uk/CLAUDE.md`. If the Role is **Non-lawyer**:
